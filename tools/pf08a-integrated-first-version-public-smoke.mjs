...
const expectedMain=process.env.EXPECTED_MAIN_PF08A_INTEGRATED||'860c16ae197aacb80c74fcb671c5745fefd809bb';
...
const files=[
 ...
 ['truth','familypilot-pf08a-savings-truth.js'],['truthCorrection','familypilot-pf08a-savings-truth-correction.js'],['truthAccountsBridge','familypilot-pf08a-savings-accounts-bridge.js'],['truthMoneyBridge','familypilot-pf08a-savings-money-bridge.js'],['truthUi','familypilot-pf08a-savings-truth-ui.js'],
...
function checks(pkg){return{
 loader:pkg.viewportAnchor.includes('familypilot-pf08a-savings-truth.js')&&pkg.viewportAnchor.includes('familypilot-m4-07-learning-mode.js'),
 ...
 singleSavingsTruth:pkg.truth.includes('purposeAllocations')&&pkg.truth.includes('actualSaved')&&pkg.truthUi.includes('Распределить имеющиеся деньги')&&pkg.truthUi.includes('field.hidden=true'),
 migrationFailClosed:pkg.truth.includes('savingsLegacyReconciliationIssues')&&pkg.truth.includes('captureLegacyPreflight')&&pkg.truthCorrection.includes('protectExisting'),
