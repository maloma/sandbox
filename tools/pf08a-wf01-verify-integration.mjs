...
if(!domain.includes('openingBalance:0')&&!/openingBalance:Number\.isFinite\(Number\(raw\?\.openingBalance\)\)\?Number\(raw\.openingBalance\):0/.test(domain))throw new Error('Zero-start wallet default is missing');
