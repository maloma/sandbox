...
if (!source.includes('<script src="./familypilot-scope.js"></script>')) {
  throw new Error('FamilyPilot scope module tag is missing');
}
if (!source.includes('<script src="./familypilot-analytics-state.js"></script>')) {
  throw new Error('Analytics state module tag is missing');
}
