...
const savingsUiFile='familypilot-savings-ui.js';
...
const savingsScript='<script src="./familypilot-savings.js"></script>';
...
const savingsMarker='<meta name="familypilot-package" content="savings-goals-v1">';
