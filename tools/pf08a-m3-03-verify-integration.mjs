...
console.log(JSON.stringify({status:'PASS',marker:'PF08A_M3_03_INTEGRATION_PASS',sourcePublishedIdentical:true,scopeMirrorsIdentical:true,inAppOnly:true,defaultLeadDays:3,homeAttention:true,comprehensiveDemoData:true,demoDataReversible:true,quickPay:true,exactOccurrenceRoute:true,noArtifacts:true},null,2));